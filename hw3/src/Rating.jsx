  ...
  return (
    <div style={{ textAlign: "center", margin: "20px" }}>
      ...
      <div style={{ marginTop: "10px" }}>
        <button onClick={() => setRatingValue(0)} style={buttonStyle}>
          Плохо
        </button>
        <button onClick={() => setRatingValue(1)} style={buttonStyle}>
          Приемлемо
        </button>
        <button onClick={() => setRatingValue(2)} style={buttonStyle}>
          Хорошо
        </button>
        <button onClick={() => setRatingValue(3)} style={buttonStyle}>
          Отлично
        </button>
      </div>
    </div>
